        ...
        <li>
          ...
          <div class="collapsible-body">
                <ul>
                  ...
                  <li><a href="updatestudentform.php"><i class="material-icons">edit</i>Edit Student</a></li>
        ...
        <li>
          ...
          <div class="collapsible-body">
            <ul>
              ...
              <li><a href="updateteacherform.php?"><i class="material-icons">edit</i>Edit Teacher</a></li>
              <li><a href="deleteteacher.php
              "><i class="material-icons">delete</i>Delete Teachers</a></li>
