...
<?php
    ...
    $query = "INSERT INTO `teacher`(`name`, `email`, `contact`, `gender`, `position`, `password`, `city`,`image`) VALUES ('$name','$email','$contact','$gender','$position','$password','$address','$image_name')";
